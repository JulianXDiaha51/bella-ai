          ...
          let welcome = {
            ...
            contextInfo: {
              externalAdReply: {
                ...
                thumbnailUrl: pp,
                sourceUrl: 'https://www.instagram.com/julzz_40?igsh=MWc2aDBzdGM3MXM0ZA==',
                mediaUrl: `http://ẉa.me/6285795349441/${Math.floor(Math.random() * 100000000000000000)}`,
              ...
              forwardedNewsletterMessageInfo: {
                newsletterJid: '12036330125498220@newsletter',
                serverMessageId: 152,
              },
            ...
            cht.id,
            {
              productMessage: {
                product: {
                  ...
                  currencyCode: 'JulzzPiw Official',
                  priceAmount1000: `Selamat datang di group ${group.subject}`,
                  productImageCount: 8,
                },
                businessOwnerJid: '628137495565@s.whatsapp.net',
                contextInfo: {
                  expiration: 86400,
        ...
        if (cfg.welcome == 'text') {
          ...
          let welcome = {
            ...
            contextInfo: {
              ...
              isForwarded: true,
              forwardedNewsletterMessageInfo: {
                newsletterJid: '12036330125478220@newsletter',
                serverMessageId: 152,
              },
          ...
          Exp.relayMessage(
            cht.id,
            {
              productMessage: {
                ...
                businessOwnerJid: '628137495560@s.whatsapp.net',
                contextInfo: {
                  expiration: 86400,
                  ephemeralSettingTimestamp: '1723572108',
                  disappearingMode: {
